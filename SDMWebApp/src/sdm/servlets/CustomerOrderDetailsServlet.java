...
@WebServlet(name = "CustomerOrderDetailsServlet", urlPatterns = { "/orderdetails" })

public class CustomerOrderDetailsServlet extends HttpServlet {

    private final String TAG = "CustomerOrderDetailsServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (role.equals("customer")){
                ...
                Order order = zone.getOrderByParams(id,subId,orderType);
                //Order order = user.getOrderByParams(idStr, subIdStr, orderType);
                if (order != null){
                    //OrderDetails orderDetails = new OrderDetails(order.getBigCart(), zone);
