...
import models.chat.ChatManager;
...
public class ServletUtils {
    ...
    public static ZonesManager getZoneManager(ServletContext servletContext){
        synchronized (zoneManagerLock){
            if (servletContext.getAttribute(ZONE_MANAGER_ATTRIBUTE_NAME)==null){
                servletContext.setAttribute(ZONE_MANAGER_ATTRIBUTE_NAME,new ZonesManager());
            }
        }
        return (ZonesManager) servletContext.getAttribute(ZONE_MANAGER_ATTRIBUTE_NAME);
    }
